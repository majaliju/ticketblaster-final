...
adele_c1 = Concert.create!({date: Faker::Date.between(from: '2023-01-01', to: '2024-05-25'), location: "Brooklyn Steel", venue_image: "https://i.imgur.com/SmFrzTC.jpg", artist_id: adele.id})
adele_c2 = Concert.create!({date: Faker::Date.between(from: '2023-01-01', to: '2024-05-25'), location: "Mao Livehouse", venue_image: "https://i.imgur.com/CghhYym.jpg", artist_id: adele.id})
adele_c3 = Concert.create!({date: Faker::Date.between(from: '2023-01-01', to: '2024-05-25'), location: "Madison Square Garden", venue_image: "https://i.imgur.com/0gd1dD0.jpg", artist_id: adele.id})
...
john_legend_c1 = Concert.create!({date: Faker::Date.between(from: '2023-01-01', to: '2024-05-25'), location: "Madison Square Garden", venue_image: "https://i.imgur.com/0gd1dD0.jpg", artist_id: john_legend.id})
...
lil_uzi_c1 = Concert.create!({date: Faker::Date.between(from: '2023-01-01', to: '2024-05-25'), location: "Brooklyn Steel", venue_image: "https://i.imgur.com/SmFrzTCm.jpg", artist_id: lil_uzi.id})
...
alicia_keys_c1 = Concert.create!({date: Faker::Date.between(from: '2023-01-01', to: '2024-05-25'), location: "Bowery Ballroom", venue_image: "https://i.imgur.com/qQN0hVK.jpg", artist_id: alicia_keys.id})
